...
ncfile_path = input(" Input the filepath to the data (ie data/is/here/wrfout_d0*) :  ")
ncfilepath = str(ncfile_path)

#What is the domain identfier? ie d02, d03?
domainID = input(" What is the domain identfier? ie d02 : ")
...
gph_pressure = input("what pressure (in hPa) do you wish to see the geopoential height, windspeed and vorticity? ie 500 : ")
gph_pressure = int(gph_pressure)

# Should I export the results and where?

results_path = input("where should I export the results ie export/results/here/ : ")
