...
# This .py file is for processing very large wrfout_d0* domains that hit memeroy errors
...
#enter the width of the desired cross-section in grid units (better if this is an even number, 40 is about right)
width = 30
#----------
